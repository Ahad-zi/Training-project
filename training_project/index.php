...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['do'] == "login" ) {
 ...
 if ($verify_password){
     ...
     header("location:index.php?msg=البريد الإلكرتوني أو كلمة السر غير صحيحة");
 
 }
     }else{
         header("location:index.php?msg=المستخدم غير موجود ");
...
<form action="index.php" method="post">
    ...
    <a href="register.php">   لا تملك حساب قم بتسجيل حساب جديد</a>
