...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['do'] == "apply"  ) {
 ...
 $query = mysqli_prepare($conn,$insert_);
 $Feedback = "تم تسجيل طلب إنضمام لجهة   ";
    ...
    echo "<h3>".$_GET['msg']."</h3>";
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php 
                $usersq = "SELECT * from trainingorganization where OrganizationID not in (select TrainingOrganizationID from  application where UserID = ".$_SESSION['id'] ." )" ;
